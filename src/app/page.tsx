...
const createItMethods = [
  { title: "Book it", description: "Customer booking forms for fast, structured job requests.", href: "/booking-forms", status: "live", icon: (<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" className="h-6 w-6"><rect x="3" y="4" width="18" height="18" rx="2" ry="2" /><line x1="16" y1="2" x2="16" y2="6" /><line x1="8" y1="2" x2="8" y2="6" /><line x1="3" y1="10" x2="21" y2="10" /></svg>) },
  ...
  { title: "Import it", description: "CSV and spreadsheet imports for batch creation at scale.", href: "/portal/intake", status: "live", icon: (<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" className="h-6 w-6"><path d="M21 15v4a2 2 0 01-2 2H5a2 2 0 01-2-2v-4" /><polyline points="7 10 12 15 17 10" /><line x1="12" y1="15" x2="12" y2="3" /></svg>) },
  { title: "Embed it", description: "Publish booking forms on your own website.", href: "/booking-forms", status: "available", icon: (<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" className="h-6 w-6"><polyline points="16 18 22 12 16 6" /><polyline points="8 6 2 12 8 18" /></svg>) },
  { title: "Shopify", description: "Sync orders from your Shopify store.", href: "/build-it", status: "available", icon: (<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" className="h-6 w-6"><path d="M6 20l1.2-12h9.6L18 20z" /><path d="M9 9c0-3 1.8-5 4-5s4 2 4 5" /></svg>) },
  { title: "WooCommerce", description: "Sync orders from your WooCommerce store.", href: "/build-it", status: "coming-soon", icon: (<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" className="h-6 w-6"><path d="M6 7h12l-1 10H7L6 7z" /><path d="M9 7a3 3 0 116 0" /></svg>) },
];
...
const QUICK_ACTIONS = [
  ...
  { label: "Upload document", href: "/portal/intake", icon: (<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="h-5 w-5"><path d="M21 15v4a2 2 0 01-2 2H5a2 2 0 01-2-2v-4" /><polyline points="17 8 12 3 7 8" /><line x1="12" y1="3" x2="12" y2="15" /></svg>) },
