...
export default function SendItPage() {
  return (
    <AppShell>
      <section className="space-y-6 rounded-[28px] border border-slate-200 bg-white p-7 shadow-sm shadow-slate-200/30">
        <header className="space-y-2">
          ...
          <h1 className="text-3xl font-semibold text-slate-950">Send it</h1>
        ...
        <WorkspaceInfoStrip
          ...
          description="No workflows are enabled in Send it yet. Current delivery focus remains replacing Wodely integrations with WooCommerce and other intake forms, then stabilizing Track-POD handoff."
          icon={
