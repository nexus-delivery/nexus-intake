  ...
  return (
    <div className="flex flex-col gap-4 px-4 py-5 sm:px-6 lg:flex-row lg:items-center lg:justify-between lg:px-8">
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
        <div className="rounded-2xl border border-white/15 bg-white/5 px-4 py-2 text-sm text-[var(--nexus-graphite)] shadow-sm shadow-black/20">
          <span className="font-semibold">Live</span> • updated 2m ago
        </div>
        <div className="rounded-2xl bg-[var(--nexus-purple)] px-4 py-2 text-sm font-semibold text-white shadow-sm shadow-[rgba(139,92,246,0.45)]">
          Workspace view
        </div>
      </div>
    </div>
