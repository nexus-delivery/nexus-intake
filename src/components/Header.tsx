  ...
  return (
    <div className="flex flex-col gap-4 px-4 py-5 sm:px-6 lg:flex-row lg:items-center lg:justify-between lg:px-8">
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
        ...
        <div className="relative flex h-10 w-10 items-center justify-center rounded-full border border-slate-200 bg-white text-slate-600 shadow-sm shadow-slate-300/30">
        ...
        <div className="rounded-2xl bg-[var(--nexus-purple)] px-5 py-2 text-sm font-semibold text-white shadow-sm shadow-[rgba(139,92,246,0.35)]">
          Product view
        </div>
      </div>
    </div>
